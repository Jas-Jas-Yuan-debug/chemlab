...
if not args.native_only:
    ...
    for flow in ['native_smoke','session_native','visual_flow','fall_flow','batch_flow','barite_flow','physics_flow','session_flow','pouring_flow','heater_flow','beginner_flow','reaction_dynamics_flow','reaction_clock_flow','concentration_limits_flow','concentration_boundary_native']:
        command = [godot]
        if flow in ['native_smoke','session_native','concentration_boundary_native']: command += ['--headless']
