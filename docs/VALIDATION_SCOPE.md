...
范围为 25°C、初始 1–250 mL；IDs 2–6 为 1e-5–1 mol/L，其他溶质为 1e-5–0.01 mol/L，水为 0。浓溶液混合只限水和 IDs 2–6。IDs 2–6、11、14 支持限定稀酸碱/Na/K 盐混合；IDs 7–9、15、16、25 常规实验台只支持自身或水的组合。BaCl₂ / Na₂SO₄ 在专用沉淀页求 Barite 平衡；Calcite/Gypsum/CO₂ 在专用气液固页分别记账。专用相平衡样品可转移至空容器，不开放后续任意混合。浓度角点与中点作为代表性测试，未承诺区间外或全部组合。
